(() => {
    ...
    (() => {
        ...
        const picker = datepicker_min("[data-datepicker]", {
            ...
            overlayButton: "Apply",
            overlayPlaceholder: "Year (4 digit)",
            startDay: 1,
        ...
        function initSliders() {
            if (document.querySelector(".main-slider__slider")) new core(".main-slider__slider", {
                ...
                on: {
                    init: function(swiper) {
                        const allSlides = document.querySelector(".swiper-pagination-total");
                        const allSlidesItems = document.querySelectorAll(".main-slider__slide:not(.swiper-slide-duplicate)");
            ...
            if (document.querySelector(".activities-slider__slider")) new core(".activities-slider__slider", {
                ...
                navigation: {
                    prevEl: ".activities-slider__button-prev",
                    nextEl: ".activities-slider__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".hotels-slider__slider")) new core(".hotels-slider__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        let moreLink = document.querySelector(".more__link");
        moreLink.addEventListener("click", smoothScroll);
        ...
        function elmYPosition(eID) {
            let elm = document.querySelector(".activities");
            let y = elm.offsetTop;
            let node = elm;
